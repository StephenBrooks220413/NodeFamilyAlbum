...
// family photos
const familyPicturesController = require('./controllers/familyPictures');
const storePicturesController = require('./controllers/storePictures');
...
app.get('/stories', storiesController)

////////// family pictures
app.get('/familypictures', familyPicturesController);
app.post('/pictures/store', authMiddleware, storePicturesController)
//////////////////////////
